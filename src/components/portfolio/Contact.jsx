...
export function Contact() {
  return (
    <section
      id="contact"
      className="px-6 md:px-10 py-24 md:py-32 border-t border-border/60 relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-serif text-[14vw] md:text-[10vw] leading-[0.9] tracking-tight text-balance"
        >
          Let's build <br />
        ...
        <div className="mt-16 grid md:grid-cols-12 gap-10">
          <div className="md:col-span-5">
            <p className="text-lg text-muted-foreground leading-relaxed">
              Got an idea, a product, or a problem worth solving? I'm currently taking on new
              full-stack projects and freelance collaborations.
            </p>
          </div>
          ...
          <div className="md:col-span-6 md:col-start-7 space-y-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-between gap-4 p-5 rounded-2xl border border-border/60 hover:border-accent hover:bg-surface/40 transition group"
            >
