...
export function Stack() {
  return (
    <section id="stack" className="px-6 md:px-10 py-24 md:py-32 border-t border-border/60">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {groups.map((g, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-border/60 bg-surface/40 p-6 hover:border-accent/50 transition-colors"
            >
              ...
              <ul className="space-y-2">
                {g.items.map((it) => (
                  <li key={it} className="text-foreground/90 text-lg font-serif">
                    {it}
                  </li>
                ))}
              </ul>
