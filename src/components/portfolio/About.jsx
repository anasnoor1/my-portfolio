    ...
    <section id="about" className="px-6 md:px-10 py-24 md:py-32 border-t border-border/60">
      <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-7 md:col-start-6 space-y-6 text-lg text-muted-foreground leading-relaxed">
          ...
          >
            I'm <span className="text-foreground">Muhammad Anas</span> — a performance-driven Full
            Stack Developer specializing in the MERN stack. I architect RESTful APIs, implement
            real-time WebSockets, and integrate secure Stripe payment flows.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            I most recently interned at <span className="text-foreground">Seebiz</span>, where I
            shipped reusable React components, automated API testing, and led Git-based
            collaboration that cut deployment errors significantly.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Outside of building products, I'm an active open-source contributor — obsessed with
            clean architecture, snappy interfaces, and getting the details right.
          </motion.p>
